<template>
  <ContentWrap>
    ...
    >
       <el-row :gutter="20">
         <el-col :span="24" :lg="6">
           <el-form-item label="店铺名称" prop="shopName" class="w-full">
             <el-input
...
import ShopForm from './conpoments/ShopForm.vue'

/** 店铺 列表 */
defineOptions({ name: 'ShopUserManager' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await ShopApi.getShopPageForUser(queryParams)
