...
import { OrderVipPlacementRecordApi } from '@/api/temu/bigCustomer'
...
const getList = async () => {
  loading.value = true
  try {
    const data = await OrderVipPlacementRecordApi.getOrderVipPlacementRecordPage(queryParams)
    const { totalPrice } = await OrderVipPlacementRecordApi.getOrderVipPlacementRecordAmountStatistics(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await OrderVipPlacementRecordApi.exportOrderVipPlacementRecord(queryParams)
